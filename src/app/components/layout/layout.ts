  ...
  hotels: HotelData[] = [
    {
      ...
      price: 202456,
      imageUrl:
        'https://bynder.onthebeach.co.uk/cdn-cgi/image/width=1400,quality=80,fit=cover,format=auto/m/7bc1d8903cfa0bd5/original/Riu-Bravo.jpg',
    ...
    },
    {
      ...
      price: 325668,
      imageUrl:
        'https://res.cloudinary.com/lastminute/image/upload/q_auto/v1709280011/XMV_21_093_-_USP_mzr7sn.jpg',
      tags: ['Maldivas', 'Dhaalu Atoll'],
    },
    {
      ...
      price: 194079,
      imageUrl:
        'https://www.riu.com/dam/02-RIU-Espanol/Building-Blocks/04-Paises/20-Tanzania/01-Zanzibar/01-Hotel-Riu-Palace-Zanzibar/Imagenes/-Slide-Home/slide-XZN-1.jpg',
    ...
    },
    {
      ...
      price: 153050,
      imageUrl:
        'https://www.riu.com/dam/02-RIU-Espanol/Building-Blocks/04-Paises/20-Tanzania/01-Zanzibar/03-Hotel-Riu-Jambo/Imagenes/-Slide-Home/JBO-slide.jpg',
      tags: ['Tanzania', 'Zanzíbar'],
    },
  ];
}
